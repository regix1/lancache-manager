...
public class XboxPrefillDaemonService : PrefillDaemonServiceBase
{
    ...
    /// <see cref="LancacheManager.Core.Services.Xbox.XboxCatalogMappingService"/> (a schedule + manual trigger
    ...
    /// never auto-name. It is DRIVEN BY <see cref="LancacheManager.Core.Services.Xbox.XboxCatalogMappingService"/>
