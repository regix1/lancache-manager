            ...
            model.Entity("LancacheManager.Models.AccountReset", b =>
                {
                    ...
                    b.ToTable("AccountResets", null, t =>
                        {
                            t.HasCheckConstraint("CK_AccountResets_Id", "\"Id\" = 1");
                        });
                });
            ...
            model.Entity("LancacheManager.Models.CachedCorruptionDetection", b =>
                {
                    ...
                    b.Property<bool>("RemovalAllowed")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("ScanId", "ServiceName", "DatasourceName")
                        .IsUnique()
            ...
            model.Entity("LancacheManager.Models.CachedDetectionSummary", b =>
                {
                    ...
                    b.Property<string>("UnmappedServicesJson")
                        .HasColumnType("text");
            ...
            model.Entity("LancacheManager.Models.PrefillCachedApp", b =>
                {
                    ...
                    b.Property<string>("CacheRevision")
                        .HasMaxLength(512)
            ...
            model.Entity("LancacheManager.Models.UserSession", b =>
                {
                    ...
                    b.Property<DateTime?>("RiotPrefillExpiresAtUtc")
                        .HasColumnType("timestamp with time zone");
