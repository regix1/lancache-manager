...
var de=Object.defineProperty;var me=(m,e,r)=>e in m?de(m,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):m[e]=r;var L=(m,e,r)=>me(m,typeof e!="symbol"?e+"":e,r);import{r as d,j as o,M as ue,W as V,L as fe,D as ge,U as be,S as pe,X as ve,a as ye,C as xe,b as we,c as Ce,R as Se}from"./react-vendor-d8C5-Seo.js";import{t as Te}from"./vendor-BmYUbuLR.js";import"./tanstack-CPlEqbpz.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))a(t);new MutationObserver(t=>{for(const s of t)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function r(t){const s={};return t.integrity&&(s.integrity=t.integrity),t.referrerPolicy&&(s.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?s.credentials="include":t.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(t){if(t.ep)return;t.ep=!0;const s=r(t);fetch(t.href,s)}})();const Be="modulepreload",$e=function(m){return"/"+m},re={},z=function(e,r,a){let t=Promise.resolve();if(r&&r.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),c=(n==null?void 0:n.nonce)||(n==null?void 0:n.getAttribute("nonce"));t=Promise.allSettled(r.map(i=>{if(i=$e(i),i in re)return;re[i]=!0;const p=i.endsWith(".css"),x=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${i}"]${x}`))return;const l=document.createElement("link");if(l.rel=p?"stylesheet":Be,p||(l.as="script"),l.crossOrigin="",l.href=i,c&&l.setAttribute("nonce",c),document.head.appendChild(l),p)return new Promise((h,f)=>{l.addEventListener("load",h),l.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${i}`)))})}))}function s(n){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=n,window.dispatchEvent(c),!c.defaultPrevented)throw n}return t.then(n=>{for(const c of n||[])c.status==="rejected"&&s(c.reason);return e().catch(s)})},u="/api",N=["steam","epic","origin","blizzard","wsus","riot"],Ae=5e3,qe=["B","KB","MB","GB","TB","PB"],Xe={DASHBOARD_CARD_ORDER:"lancache_dashboard_card_order",DASHBOARD_CARD_VISIBILITY:"lancache_dashboard_card_visibility"},J={},Ie=()=>{if(!(typeof import.meta<"u"&&(J!=null&&J.VITE_API_URL)))return""},Z=Ie();class De{constructor(){L(this,"deviceId");L(this,"isAuthenticated");L(this,"authChecked");this.deviceId=this.getOrCreateDeviceId(),this.isAuthenticated=!1,this.authChecked=!1}getOrCreateDeviceId(){let e=localStorage.getItem("lancache_device_id");return e||(e="xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(r){const a=Math.random()*16|0;return(r==="x"?a:a&3|8).toString(16)}),localStorage.setItem("lancache_device_id",e)),e}async checkAuth(){try{const e=await fetch(`${Z}/api/auth/check`,{headers:{"X-Device-Id":this.deviceId}});if(e.ok){const r=await e.json();return this.isAuthenticated=r.isAuthenticated,this.authChecked=!0,r}return this.isAuthenticated=!1,this.authChecked=!0,{requiresAuth:!0,isAuthenticated:!1}}catch(e){return console.error("Auth check failed:",e),this.authChecked=!0,{requiresAuth:!1,isAuthenticated:!1,error:e.message}}}async register(e,r=null){try{const a=await fetch(`${Z}/api/auth/register`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({deviceId:this.deviceId,apiKey:e,deviceName:r||this.getDeviceName()})}),t=await a.json();return a.ok&&t.success?(this.isAuthenticated=!0,localStorage.setItem("lancache_auth_registered","true"),{success:!0,message:t.message}):{success:!1,message:t.message||"Registration failed"}}catch(a){return console.error("Registration failed:",a),{success:!1,message:a.message||"Network error during registration"}}}async regenerateApiKey(){try{const e=await fetch(`${Z}/api/auth/regenerate-key`,{method:"POST",headers:{"Content-Type":"application/json","X-Device-Id":this.deviceId}}),r=await e.json();return e.ok&&r.success?(this.clearAuth(),this.isAuthenticated=!1,{success:!0,message:r.message,warning:r.warning}):{success:!1,message:r.message||"Failed to regenerate API key"}}catch(e){return console.error("Failed to regenerate API key:",e),{success:!1,message:e.message||"Network error while regenerating API key"}}}getDeviceName(){const e=navigator.userAgent;let r="Unknown OS",a="Unknown Browser";return e.indexOf("Win")!==-1?r="Windows":e.indexOf("Mac")!==-1?r="macOS":e.indexOf("Linux")!==-1?r="Linux":e.indexOf("Android")!==-1?r="Android":e.indexOf("iOS")!==-1&&(r="iOS"),e.indexOf("Chrome")!==-1?a="Chrome":e.indexOf("Safari")!==-1?a="Safari":e.indexOf("Firefox")!==-1?a="Firefox":e.indexOf("Edge")!==-1&&(a="Edge"),`${a} on ${r}`}getAuthHeaders(){return{"X-Device-Id":this.deviceId}}handleUnauthorized(){this.isAuthenticated=!1,localStorage.removeItem("lancache_auth_registered")}clearAuth(){this.isAuthenticated=!1,localStorage.removeItem("lancache_auth_registered")}isRegistered(){return localStorage.getItem("lancache_auth_registered")==="true"}}const G=new De;class I{static async handleResponse(e){if(e.status===401){G.handleUnauthorized();const r=await e.text().catch(()=>"");throw new Error(`Authentication required: ${r||"Please provide API key"}`)}if(!e.ok){const r=await e.text().catch(()=>"");throw new Error(`HTTP ${e.status}: ${r||e.statusText}`)}return e.json()}static getHeaders(e={}){return{...G.getAuthHeaders(),...e}}static async getCacheInfo(e){try{const r=await fetch(`${u}/management/cache`,{signal:e,headers:this.getHeaders()});return await this.handleResponse(r)}catch(r){throw r.name==="AbortError"||console.error("getCacheInfo error:",r),r}}static async getActiveDownloads(e){try{const r=await fetch(`${u}/downloads/active`,{signal:e,headers:this.getHeaders()});return await this.handleResponse(r)}catch(r){throw r.name==="AbortError"||console.error("getActiveDownloads error:",r),r}}static async getLatestDownloads(e,r=50){try{const t=await fetch(`${u}/downloads/latest?count=${r==="unlimited"?9999:r}`,{signal:e,headers:this.getHeaders()});return await this.handleResponse(t)}catch(a){throw a.name==="AbortError"||console.error("getLatestDownloads error:",a),a}}static async getClientStats(e){try{const r=await fetch(`${u}/stats/clients`,{signal:e,headers:this.getHeaders()});return await this.handleResponse(r)}catch(r){throw r.name==="AbortError"||console.error("getClientStats error:",r),r}}static async getServiceStats(e,r=null){try{const a=r?`${u}/stats/services?since=${r}`:`${u}/stats/services`,t=await fetch(a,{signal:e,headers:this.getHeaders()});return await this.handleResponse(t)}catch(a){throw a.name==="AbortError"||console.error("getServiceStats error:",a),a}}static async getDashboardStats(e="24h",r){try{const a=await fetch(`${u}/stats/dashboard?period=${e}`,{signal:r,headers:this.getHeaders()});return await this.handleResponse(a)}catch(a){throw a.name==="AbortError"||console.error("getDashboardStats error:",a),a}}static async getCacheEffectiveness(e="24h",r){try{const a=await fetch(`${u}/stats/cache-effectiveness?period=${e}`,{signal:r,headers:this.getHeaders()});return await this.handleResponse(a)}catch(a){throw a.name==="AbortError"||console.error("getCacheEffectiveness error:",a),a}}static async getTimelineStats(e="24h",r="hourly",a){try{const t=await fetch(`${u}/stats/timeline?period=${e}&interval=${r}`,{signal:a,headers:this.getHeaders()});return await this.handleResponse(t)}catch(t){throw t.name==="AbortError"||console.error("getTimelineStats error:",t),t}}static async getBandwidthSaved(e="all",r){try{const a=await fetch(`${u}/stats/bandwidth-saved?period=${e}`,{signal:r,headers:this.getHeaders()});return await this.handleResponse(a)}catch(a){throw a.name==="AbortError"||console.error("getBandwidthSaved error:",a),a}}static async getTopGames(e=10,r="7d",a){try{const t=await fetch(`${u}/stats/top-games?limit=${e}&period=${r}`,{signal:a,headers:this.getHeaders()});return await this.handleResponse(t)}catch(t){throw t.name==="AbortError"||console.error("getTopGames error:",t),t}}static async clearAllCache(){try{const e=await fetch(`${u}/management/cache/clear-all`,{method:"POST",headers:this.getHeaders({"Content-Type":"application/json"}),signal:AbortSignal.timeout(1e4)});return await this.handleResponse(e)}catch(e){throw console.error("clearAllCache error:",e),e}}static async getCacheClearStatus(e){try{const r=await fetch(`${u}/management/cache/clear-status/${e}`,{signal:AbortSignal.timeout(5e3),headers:this.getHeaders()});return await this.handleResponse(r)}catch(r){throw console.error("getCacheClearStatus error:",r),r}}static async cancelCacheClear(e){try{const r=await fetch(`${u}/management/cache/clear-cancel/${e}`,{method:"POST",headers:this.getHeaders({"Content-Type":"application/json"}),signal:AbortSignal.timeout(5e3)});return await this.handleResponse(r)}catch(r){throw console.error("cancelCacheClear error:",r),r}}static async getActiveCacheOperations(){try{const e=await fetch(`${u}/management/cache/active-operations`,{signal:AbortSignal.timeout(5e3),headers:this.getHeaders()});return await this.handleResponse(e)}catch(e){throw console.error("getActiveCacheOperations error:",e),e}}static async clearCache(e=null){return e?await this.removeServiceFromLogs(e):await this.clearAllCache()}static async resetDatabase(){try{const e=await fetch(`${u}/management/database`,{method:"DELETE",headers:this.getHeaders({"Content-Type":"application/json"}),signal:AbortSignal.timeout(6e4)});return await this.handleResponse(e)}catch(e){throw console.error("resetDatabase error:",e),e}}static async resetLogPosition(){try{const e=await fetch(`${u}/management/reset-logs`,{method:"POST",headers:this.getHeaders({"Content-Type":"application/json"}),signal:AbortSignal.timeout(6e4)});return await this.handleResponse(e)}catch(e){throw console.error("resetLogPosition error:",e),e}}static async processAllLogs(){try{const e=await fetch(`${u}/management/process-all-logs`,{method:"POST",headers:this.getHeaders({"Content-Type":"application/json"}),signal:AbortSignal.timeout(12e4)});return await this.handleResponse(e)}catch(e){throw console.error("processAllLogs error:",e),e}}static async cancelProcessing(){try{const e=await fetch(`${u}/management/cancel-processing`,{method:"POST",headers:this.getHeaders({"Content-Type":"application/json"}),signal:AbortSignal.timeout(1e4)});return await this.handleResponse(e)}catch(e){throw console.error("cancelProcessing error:",e),e}}static async getProcessingStatus(){try{const e=await fetch(`${u}/management/processing-status`,{signal:AbortSignal.timeout(5e3),headers:this.getHeaders()});return await this.handleResponse(e)}catch(e){throw console.error("getProcessingStatus error:",e),e}}static async removeServiceFromLogs(e){try{const r=await fetch(`${u}/management/logs/remove-service`,{method:"POST",headers:this.getHeaders({"Content-Type":"application/json"}),body:JSON.stringify({service:e}),signal:AbortSignal.timeout(12e4)});return await this.handleResponse(r)}catch(r){throw console.error("removeServiceFromLogs error:",r),r}}static async getServiceLogCounts(){try{const e=await fetch(`${u}/management/logs/service-counts`,{signal:AbortSignal.timeout(3e4),headers:this.getHeaders()});return await this.handleResponse(e)}catch(e){throw console.error("getServiceLogCounts error:",e),e}}static async getConfig(){try{const e=await fetch(`${u}/management/config`,{signal:AbortSignal.timeout(5e3),headers:this.getHeaders()});return await this.handleResponse(e)}catch(e){return console.error("getConfig error:",e),{cachePath:"/cache",logPath:"/logs/access.log",services:["steam","epic","origin","blizzard","wsus","riot"]}}}}class Q{static generateMockData(e=50){const r=["192.168.1.100","192.168.1.101","192.168.1.102","192.168.1.103","192.168.1.104","192.168.1.105","192.168.1.106","192.168.1.107","192.168.1.108","192.168.1.109","192.168.1.110","192.168.1.111","10.0.0.50","10.0.0.51","10.0.0.52","10.0.0.53","127.0.0.1"],a=[{name:"Counter-Strike 2",size:32212254720},{name:"Dota 2",size:37580963840},{name:"Team Fortress 2",size:26843545600},{name:"Grand Theft Auto V",size:102005473280},{name:"Apex Legends",size:64424509440},{name:"Dead by Daylight",size:48318382080},{name:"Marvel Rivals",size:59055800320},{name:"Path of Exile",size:42949672960},{name:"Warframe",size:53687091200},{name:"Destiny 2",size:112742891520},{name:"Rust",size:37580963840},{name:"Valheim",size:1073741824},{name:"Unknown Steam Game",size:16106127360}],t={totalCacheSize:2e12,usedCacheSize:145e10,freeCacheSize:55e10,usagePercent:72.5,totalFiles:48293+(typeof e=="number"?e:500)*100,serviceSizes:{steam:65e10,epic:32e10,origin:18e10,blizzard:15e10,wsus:1e11,riot:5e10}},s=[],n=new Date,c=e==="unlimited"?500:e,i={};for(let l=0;l<c;l++){const h=N[Math.floor(Math.random()*N.length)],f=r[Math.floor(Math.random()*r.length)],w=Math.random()<.3,k=Math.pow(l/c,2)*2160,g=new Date(n.getTime()-k*60*60*1e3-Math.random()*36e5);let S;if(w){const D=new Date(g.getTime()+Math.random()*5e3);S={id:l+1,service:h,clientIp:f,startTime:g.toISOString(),endTime:D.toISOString(),cacheHitBytes:0,cacheMissBytes:0,totalBytes:0,cacheHitPercent:0,isActive:!1,gameName:null}}else{let D=null,E;if(h==="steam"&&Math.random()<.7){const H=a[Math.floor(Math.random()*a.length)];D=H.name,E=Math.floor(H.size*(.8+Math.random()*.2))}else E=Math.floor(Math.random()*50*1024*1024*1024);const T=Math.min(.95,.1+k/2160*.85),M=Math.floor(E*T),W=E-M,q=T>.8?500*1024*1024:50*1024*1024,F=E/q*1e3,X=new Date(g.getTime()+F);S={id:l+1,service:h,clientIp:f,startTime:g.toISOString(),endTime:X.toISOString(),cacheHitBytes:M,cacheMissBytes:W,totalBytes:E,cacheHitPercent:M/E*100,isActive:l<3&&k<.5,gameName:D,gameAppId:D&&D!=="Unknown Steam Game"?2e5+Math.floor(Math.random()*2e6):null}}i[f]||(i[f]={totalCacheHitBytes:0,totalCacheMissBytes:0,totalDownloads:0,lastSeen:g}),i[f].totalCacheHitBytes+=S.cacheHitBytes||0,i[f].totalCacheMissBytes+=S.cacheMissBytes||0,i[f].totalDownloads+=1,g>i[f].lastSeen&&(i[f].lastSeen=g),s.push(S)}s.sort((l,h)=>new Date(h.startTime).getTime()-new Date(l.startTime).getTime());const p=r.map(l=>{const h=i[l];if(h){const f=h.totalCacheHitBytes+h.totalCacheMissBytes;return{clientIp:l,totalCacheHitBytes:h.totalCacheHitBytes,totalCacheMissBytes:h.totalCacheMissBytes,totalBytes:f,cacheHitPercent:f>0?h.totalCacheHitBytes/f*100:0,totalDownloads:h.totalDownloads,lastSeen:h.lastSeen.toISOString()}}else return{clientIp:l,totalCacheHitBytes:0,totalCacheMissBytes:0,totalBytes:0,cacheHitPercent:0,totalDownloads:0,lastSeen:null}}).filter(l=>l.totalBytes>0),x=N.map(l=>{var k;const h=s.filter(g=>g.service===l),f=h.reduce((g,S)=>g+S.cacheHitBytes,0),w=h.reduce((g,S)=>g+S.cacheMissBytes,0);return{service:l,totalCacheHitBytes:f||t.serviceSizes[l]*.8,totalCacheMissBytes:w||t.serviceSizes[l]*.2,totalBytes:f+w||t.serviceSizes[l],cacheHitPercent:f+w>0?f/(f+w)*100:80,totalDownloads:h.length,lastActivity:((k=h[0])==null?void 0:k.startTime)||new Date(n.getTime()-Math.random()*72e5).toISOString()}});return{cacheInfo:t,activeDownloads:s.filter(l=>l.isActive),latestDownloads:s,clientStats:p,serviceStats:x}}static generateRealtimeUpdate(){const e=["192.168.1.100","192.168.1.101","192.168.1.102","192.168.1.103","192.168.1.104","192.168.1.105","192.168.1.106","192.168.1.107"];if(Math.random()<.2)return{id:Date.now(),service:N[Math.floor(Math.random()*N.length)],clientIp:e[Math.floor(Math.random()*e.length)],startTime:new Date().toISOString(),endTime:new Date().toISOString(),cacheHitBytes:0,cacheMissBytes:0,totalBytes:0,cacheHitPercent:0,isActive:!1};const a=Math.floor(Math.random()*5e8),t=Math.floor(Math.random()*1e8);return{id:Date.now(),service:N[Math.floor(Math.random()*N.length)],clientIp:e[Math.floor(Math.random()*e.length)],startTime:new Date().toISOString(),endTime:null,cacheHitBytes:a,cacheMissBytes:t,totalBytes:a+t,cacheHitPercent:a/(a+t)*100,isActive:!0,gameName:Math.random()<.5?"Counter-Strike 2":null}}}const ee={},oe=d.createContext(void 0),Ye=()=>{const m=d.useContext(oe);if(!m)throw new Error("useData must be used within DataProvider");return m},Ee=({children:m})=>{const[e,r]=d.useState(!1),[a,t]=d.useState(20),[s,n]=d.useState(20),[c,i]=d.useState(null),[p,x]=d.useState([]),[l,h]=d.useState([]),[f,w]=d.useState([]),[k,g]=d.useState([]),[S,D]=d.useState(!0),[E,T]=d.useState(null),[M,W]=d.useState(!1),[q,F]=d.useState(null),[X,H]=d.useState("checking"),O=d.useRef(!0),R=d.useRef(!1),Y=d.useRef(!1),b=d.useRef(null),C=d.useRef(null),se=()=>{if(!(typeof import.meta<"u"&&(ee!=null&&ee.VITE_API_URL)))return""},ne=async()=>{try{const y=se();return(await fetch(`${y}/health`,{signal:AbortSignal.timeout(5e3)})).ok?(H("connected"),!0):(H("error"),!1)}catch{return H("disconnected"),!1}},U=async()=>{if(!(Y.current&&!O.current)){Y.current=!0,b.current&&b.current.abort(),b.current=new AbortController;try{if(O.current&&D(!0),e){const y=a==="unlimited"?100:Math.min(Number(a),100),v=Q.generateMockData(y);i(v.cacheInfo),x(v.activeDownloads),h(v.latestDownloads),w(v.clientStats),g(v.serviceStats),T(null),H("connected"),R.current=!0}else if(await ne())try{const K=setTimeout(()=>{var B;return(B=b.current)==null?void 0:B.abort()},M?3e4:1e4);if(O.current){const[B,A]=await Promise.all([I.getCacheInfo(b.current.signal),I.getActiveDownloads(b.current.signal)]);B&&i(B),A&&x(A);const P=await I.getLatestDownloads(b.current.signal,20);P&&(h(P),R.current=!0),setTimeout(async()=>{var $;if(!(($=b.current)!=null&&$.signal.aborted))try{const[j,_]=await Promise.all([I.getClientStats(b.current.signal),I.getServiceStats(b.current.signal)]);j&&w(j),_&&g(_)}catch{}},100)}else{const B=s==="unlimited"?100:s,[A,P,$,j,_]=await Promise.allSettled([I.getCacheInfo(b.current.signal),I.getActiveDownloads(b.current.signal),I.getLatestDownloads(b.current.signal,B),I.getClientStats(b.current.signal),I.getServiceStats(b.current.signal)]);A.status==="fulfilled"&&A.value!==void 0&&i(A.value),P.status==="fulfilled"&&P.value!==void 0&&x(P.value),$.status==="fulfilled"&&$.value!==void 0&&(h($.value),R.current=!0,M&&$.value.length>0&&F(he=>({...he,message:`Processing logs... Found ${$.value.length} downloads`,downloadCount:$.value.length}))),j.status==="fulfilled"&&j.value!==void 0&&w(j.value),_.status==="fulfilled"&&_.value!==void 0&&g(_.value)}clearTimeout(K),T(null)}catch(v){R.current||(v.name==="AbortError"?T("Request timeout - the server may be busy"):T("Failed to fetch data from API"))}else R.current||T("Cannot connect to API server")}catch(y){console.error("Error in fetchData:",y),!R.current&&!e&&T("An unexpected error occurred")}finally{O.current&&(D(!1),O.current=!1),Y.current=!1}}},ce=y=>{if(e){const v=y==="unlimited"?100:Math.min(y,100);t(v)}},ie=y=>{n(y==="unlimited"?100:y)},te=()=>M?15e3:s==="unlimited"||s>100?3e4:Ae;d.useEffect(()=>{if(!e){U();const y=te();return C.current=setInterval(U,y),()=>{C.current&&(clearInterval(C.current),C.current=null),b.current&&b.current.abort()}}},[M,e,s]),d.useEffect(()=>{if(e){C.current&&(clearInterval(C.current),C.current=null),i(null),x([]),h([]),w([]),g([]);const y=a==="unlimited"?100:Math.min(Number(a),100),v=Q.generateMockData(y);i(v.cacheInfo),x(v.activeDownloads),h(v.latestDownloads),w(v.clientStats),g(v.serviceStats),T(null),H("connected"),R.current=!0;const K=3e4;return C.current=setInterval(()=>{const B=Q.generateRealtimeUpdate();h(A=>[B,...A.slice(0,99)]),x(A=>[B,...A.filter($=>$.id!==B.id)].slice(0,5))},K),()=>{C.current&&(clearInterval(C.current),C.current=null)}}else i(null),x([]),h([]),w([]),g([]),T(null),R.current=!1,O.current=!0,U()},[e,a]),d.useEffect(()=>()=>{C.current&&clearInterval(C.current),b.current&&b.current.abort()},[]);const le={mockMode:e,setMockMode:r,mockDownloadCount:a,updateMockDataCount:ce,apiDownloadCount:s,updateApiDownloadCount:ie,cacheInfo:c,activeDownloads:p,latestDownloads:l,clientStats:f,serviceStats:k,loading:S,error:E,fetchData:U,clearAllData:()=>{i(null),x([]),h([]),w([]),g([]),R.current=!1},isProcessingLogs:M,setIsProcessingLogs:W,processingStatus:q,setProcessingStatus:F,connectionStatus:X,getCurrentRefreshInterval:te};return o.jsx(oe.Provider,{value:le,children:m})},Me=({title:m="LANCache Manager",subtitle:e="High-performance cache monitoring & management",connectionStatus:r="connected"})=>{const t=(()=>{switch(r){case"connected":return{color:"cache-hit",text:"Connected",icon:o.jsx(V,{className:"w-4 h-4"})};case"disconnected":return{color:"text-themed-error",text:"Disconnected",icon:o.jsx(V,{className:"w-4 h-4"})};case"reconnecting":return{color:"cache-miss",text:"Reconnecting...",icon:o.jsx(V,{className:"w-4 h-4 animate-pulse"})};default:return{color:"text-themed-muted",text:"Unknown",icon:o.jsx(V,{className:"w-4 h-4"})}}})();return o.jsx("header",{className:"border-b",style:{backgroundColor:"var(--theme-nav-bg)",borderColor:"var(--theme-nav-border)"},children:o.jsx("div",{className:"container mx-auto px-4",children:o.jsxs("div",{className:"flex items-center justify-between h-16 min-w-0",children:[o.jsxs("div",{className:"flex items-center space-x-2 sm:space-x-3 min-w-0 flex-1",children:[o.jsx("div",{className:"p-1.5 sm:p-2 rounded-lg flex-shrink-0",style:{backgroundColor:"var(--theme-icon-blue)"},children:o.jsx(ue,{className:"w-5 h-5 sm:w-6 sm:h-6 text-white"})}),o.jsxs("div",{className:"min-w-0 flex-1",children:[o.jsx("h1",{className:"text-lg sm:text-xl font-bold text-themed-primary truncate",children:m}),o.jsx("p",{className:"text-xs sm:text-sm text-themed-muted truncate hidden sm:block",children:e})]})]}),o.jsx("div",{className:"flex items-center space-x-1 sm:space-x-2 flex-shrink-0",children:o.jsxs("div",{className:`flex items-center space-x-1 ${t.color}`,children:[t.icon,o.jsx("span",{className:"text-xs sm:text-sm font-medium hidden sm:inline",children:t.text})]})})]})})})},Re=({activeTab:m,setActiveTab:e})=>{var n;const[r,a]=d.useState(!1),t=[{id:"dashboard",label:"Dashboard",icon:fe},{id:"downloads",label:"Downloads",icon:ge},{id:"clients",label:"Clients",icon:be},{id:"management",label:"Management",icon:pe}],s=({tab:c,isActive:i,onClick:p,className:x=""})=>{const l=c.icon;return o.jsxs("button",{onClick:p,className:`flex items-center space-x-2 px-3 py-2 rounded-lg font-medium transition-all duration-200 ${x}`,style:{color:i?"var(--theme-nav-tab-active)":"var(--theme-nav-tab-inactive)",backgroundColor:"transparent"},onMouseEnter:h=>{i||(h.currentTarget.style.color="var(--theme-nav-tab-hover)",h.currentTarget.style.backgroundColor="var(--theme-nav-mobile-item-hover)")},onMouseLeave:h=>{i||(h.currentTarget.style.color="var(--theme-nav-tab-inactive)",h.currentTarget.style.backgroundColor="transparent")},children:[o.jsx(l,{className:"w-5 h-5"}),o.jsx("span",{children:c.label}),i&&o.jsx("div",{className:"absolute bottom-0 left-0 right-0 h-0.5 rounded-full",style:{backgroundColor:"var(--theme-nav-tab-active-border)"}})]})};return o.jsx("nav",{className:"border-b",style:{backgroundColor:"var(--theme-nav-bg)",borderColor:"var(--theme-nav-border)"},children:o.jsxs("div",{className:"container mx-auto px-4",children:[o.jsx("div",{className:"hidden md:flex space-x-1 h-12 items-center",children:t.map(c=>o.jsx("div",{className:"relative",children:o.jsx(s,{tab:c,isActive:m===c.id,onClick:()=>e(c.id)})},c.id))}),o.jsxs("div",{className:"md:hidden",children:[o.jsxs("div",{className:"flex items-center justify-between h-12",children:[o.jsx("div",{className:"flex items-center space-x-2",children:o.jsx("span",{className:"font-medium text-themed-primary",children:((n=t.find(c=>c.id===m))==null?void 0:n.label)||"Dashboard"})}),o.jsx("button",{onClick:()=>a(!r),className:"p-2 rounded-lg transition-colors",style:{color:"var(--theme-nav-tab-inactive)",backgroundColor:"transparent"},onMouseEnter:c=>{c.currentTarget.style.backgroundColor="var(--theme-nav-mobile-item-hover)"},onMouseLeave:c=>{c.currentTarget.style.backgroundColor="transparent"},children:r?o.jsx(ve,{className:"w-5 h-5"}):o.jsx(ye,{className:"w-5 h-5"})})]}),r&&o.jsx("div",{className:"border-t py-2 space-y-1",style:{backgroundColor:"var(--theme-nav-mobile-menu-bg)",borderColor:"var(--theme-nav-border)"},children:t.map(c=>o.jsx(s,{tab:c,isActive:m===c.id,onClick:()=>{e(c.id),a(!1)},className:"w-full justify-start"},c.id))})]})]})})};class ke extends d.Component{constructor(e){super(e),this.state={hasError:!1}}static getDerivedStateFromError(e){return{hasError:!0,error:e}}componentDidCatch(e,r){console.error("Error caught by boundary:",e,r)}render(){var e;return this.state.hasError?o.jsx("div",{className:"min-h-screen bg-themed-primary flex items-center justify-center p-4",children:o.jsx("div",{className:"alert-error rounded-lg p-6 max-w-md w-full",children:o.jsxs("div",{className:"flex items-start space-x-3",children:[o.jsx(xe,{className:"w-5 h-5 mt-0.5"}),o.jsxs("div",{children:[o.jsx("h3",{className:"text-lg font-semibold mb-2",children:"Something went wrong"}),o.jsx("p",{className:"text-sm text-themed-secondary",children:((e=this.state.error)==null?void 0:e.message)||"An unexpected error occurred"}),o.jsx("button",{onClick:()=>window.location.reload(),className:"mt-4 px-4 py-2 action-delete rounded-lg text-sm smooth-transition",children:"Reload Page"})]})]})})}):this.props.children}}const He=({message:m,size:e="md",fullScreen:r=!1})=>{const a={xs:"w-4 h-4",sm:"w-6 h-6",md:"w-8 h-8",lg:"w-12 h-12",xl:"w-16 h-16"},t=o.jsxs("div",{className:"flex flex-col items-center justify-center space-y-4",children:[o.jsx(we,{className:`${a[e]} text-themed-primary animate-spin`}),m&&o.jsx("p",{className:"text-sm text-themed-muted",children:m})]});return r?o.jsx("div",{className:"fixed inset-0 bg-themed-primary bg-opacity-50 flex items-center justify-center z-50",children:t}):o.jsx("div",{className:"flex items-center justify-center min-h-[200px]",children:t})},ae=d.lazy(()=>z(()=>import("./Dashboard-DXh0STSS.js"),__vite__mapDeps([0,1,2,3,4,5,6]))),Pe=d.lazy(()=>z(()=>import("./DownloadsTab-fqUh5i1m.js"),__vite__mapDeps([7,1,2,3,4,8]))),je=d.lazy(()=>z(()=>import("./ClientsTab-DW8Sj1_s.js"),__vite__mapDeps([9,1,2,3,4,6]))),Ne=d.lazy(()=>z(()=>import("./ServicesTab-CoN9-kJX.js"),__vite__mapDeps([10,1,2,3,4,6]))),Oe=d.lazy(()=>z(()=>import("./ManagementTab-cpYYwp4E.js"),__vite__mapDeps([11,1,2,3,4,8,12]))),_e=()=>{const[m,e]=d.useState("dashboard"),r=()=>{const a=(()=>{switch(m){case"dashboard":return ae;case"downloads":return Pe;case"clients":return je;case"services":return Ne;case"management":return Oe;default:return ae}})();return o.jsx(d.Suspense,{fallback:o.jsx(He,{fullScreen:!1,message:"Loading..."}),children:o.jsx(a,{})})};return o.jsx(ke,{children:o.jsx(Ee,{children:o.jsxs("div",{className:"min-h-screen",style:{backgroundColor:"var(--theme-bg-primary)",color:"var(--theme-text-primary)"},children:[o.jsx(Me,{}),o.jsx(Re,{activeTab:m,setActiveTab:e}),o.jsx("main",{className:"container mx-auto px-4 py-6",children:r()})]})})})};class Le{constructor(){L(this,"currentTheme",null);L(this,"styleElement",null)}getContrastText(e){return!e||e==="transparent"?"var(--theme-text-primary)":getComputedStyle(document.documentElement).getPropertyValue("--theme-button-text").trim()||"#ffffff"}async loadThemes(){const e=this.getBuiltInThemes(),r=[],a=[];try{const n=await fetch(`${u}/theme`);if(n.ok){const c=await n.json();for(const i of c)if(i.format==="toml")try{const p=await fetch(`${u}/theme/${i.id}`);if(p.status===404){a.push(i.id);continue}if(p.ok){const x=await p.text(),l=this.parseTomlTheme(x);l&&r.push(l)}}catch(p){console.error(`Failed to load theme ${i.id}:`,p)}if(a.length>0&&this.currentTheme&&a.includes(this.currentTheme.meta.id)){const i=e.find(p=>p.meta.id==="dark-default");i&&this.applyTheme(i)}}}catch(n){console.error("Failed to load themes from server:",n)}const t=[...e],s=new Set(t.map(n=>n.meta.id));return r.forEach(n=>{s.has(n.meta.id)||(t.push(n),s.add(n.meta.id))}),t}getBuiltInThemes(){return[{meta:{id:"dark-default",name:"Dark Default",description:"Default dark theme with blue accents",author:"System",version:"1.0.0",isDark:!0},colors:{primaryColor:"#3b82f6",secondaryColor:"#8b5cf6",accentColor:"#06b6d4",bgPrimary:"#111827",bgSecondary:"#1f2937",bgTertiary:"#374151",bgHover:"#4b5563",textPrimary:"#ffffff",textSecondary:"#d1d5db",textMuted:"#9ca3af",textAccent:"#60a5fa",textPlaceholder:"#6b7280",dragHandleColor:"#6b7280",dragHandleHover:"#60a5fa",borderPrimary:"#374151",borderSecondary:"#4b5563",borderFocus:"#3b82f6",navBg:"#1f2937",navBorder:"#374151",navTabActive:"#3b82f6",navTabInactive:"#9ca3af",navTabHover:"#ffffff",navTabActiveBorder:"#3b82f6",navMobileMenuBg:"#1f2937",navMobileItemHover:"#374151",success:"#10b981",successBg:"#064e3b",successText:"#34d399",warning:"#fb923c",warningBg:"#44403c",warningText:"#fcd34d",error:"#ef4444",errorBg:"#7f1d1d",errorText:"#fca5a5",info:"#3b82f6",infoBg:"#1e3a8a",infoText:"#93c5fd",steamColor:"#3b82f6",epicColor:"#8b5cf6",originColor:"#10b981",blizzardColor:"#ef4444",wsusColor:"#06b6d4",riotColor:"#f59e0b",cardBg:"#1f2937",cardBorder:"#374151",buttonBg:"#3b82f6",buttonHover:"#2563eb",buttonText:"#ffffff",inputBg:"#374151",inputBorder:"#4b5563",inputFocus:"#3b82f6",badgeBg:"#3b82f6",badgeText:"#ffffff",progressBar:"#3b82f6",progressBg:"#374151",hitRateHighBg:"#064e3b",hitRateHighText:"#34d399",hitRateMediumBg:"#1e3a8a",hitRateMediumText:"#93c5fd",hitRateLowBg:"#44403c",hitRateLowText:"#fbbf24",hitRateWarningBg:"#44403c",hitRateWarningText:"#fcd34d",actionResetBg:"#f59e0b",actionResetHover:"#d97706",actionProcessBg:"#10b981",actionProcessHover:"#059669",actionDeleteBg:"#ef4444",actionDeleteHover:"#dc2626",iconBgBlue:"#3b82f6",iconBgGreen:"#10b981",iconBgEmerald:"#10b981",iconBgPurple:"#8b5cf6",iconBgIndigo:"#6366f1",iconBgOrange:"#f97316",iconBgYellow:"#eab308",iconBgCyan:"#06b6d4",iconBgRed:"#ef4444",chartColor1:"#3b82f6",chartColor2:"#10b981",chartColor3:"#f59e0b",chartColor4:"#ef4444",chartColor5:"#8b5cf6",chartColor6:"#06b6d4",chartColor7:"#f97316",chartColor8:"#ec4899",chartBorderColor:"#1f2937",chartGridColor:"#374151",chartTextColor:"#9ca3af",chartCacheHitColor:"#10b981",chartCacheMissColor:"#f59e0b",scrollbarTrack:"#374151",scrollbarThumb:"#6B7280",scrollbarHover:"#9CA3AF",publicAccessBg:"rgba(16, 185, 129, 0.2)",publicAccessText:"#34d399",publicAccessBorder:"rgba(16, 185, 129, 0.3)",securedAccessBg:"rgba(245, 158, 11, 0.2)",securedAccessText:"#fbbf24",securedAccessBorder:"rgba(245, 158, 11, 0.3)"}},{meta:{id:"light-default",name:"Light Default",description:"Default light theme with blue accents",author:"System",version:"1.0.0",isDark:!1},colors:{primaryColor:"#3b82f6",secondaryColor:"#8b5cf6",accentColor:"#06b6d4",bgPrimary:"#f8f9fa",bgSecondary:"#ffffff",bgTertiary:"#f3f4f6",bgHover:"#e5e7eb",textPrimary:"#111827",textSecondary:"#374151",textMuted:"#6b7280",textAccent:"#2563eb",textPlaceholder:"#9ca3af",dragHandleColor:"#9ca3af",dragHandleHover:"#2563eb",borderPrimary:"#e5e7eb",borderSecondary:"#d1d5db",borderFocus:"#3b82f6",navBg:"#ffffff",navBorder:"#e5e7eb",navTabActive:"#3b82f6",navTabInactive:"#6b7280",navTabHover:"#111827",navTabActiveBorder:"#3b82f6",navMobileMenuBg:"#ffffff",navMobileItemHover:"#f3f4f6",success:"#10b981",successBg:"#d1fae5",successText:"#047857",warning:"#f97316",warningBg:"#fef3c7",warningText:"#b45309",error:"#ef4444",errorBg:"#fee2e2",errorText:"#991b1b",info:"#3b82f6",infoBg:"#dbeafe",infoText:"#1e40af",steamColor:"#3b82f6",epicColor:"#8b5cf6",originColor:"#10b981",blizzardColor:"#ef4444",wsusColor:"#06b6d4",riotColor:"#f59e0b",cardBg:"#ffffff",cardBorder:"#e5e7eb",buttonBg:"#3b82f6",buttonHover:"#2563eb",buttonText:"#ffffff",inputBg:"#ffffff",inputBorder:"#d1d5db",inputFocus:"#3b82f6",badgeBg:"#3b82f6",badgeText:"#ffffff",progressBar:"#3b82f6",progressBg:"#e5e7eb",hitRateHighBg:"#d1fae5",hitRateHighText:"#047857",hitRateMediumBg:"#dbeafe",hitRateMediumText:"#1e40af",hitRateLowBg:"#fef3c7",hitRateLowText:"#92400e",hitRateWarningBg:"#fef3c7",hitRateWarningText:"#92400e",actionResetBg:"#f59e0b",actionResetHover:"#d97706",actionProcessBg:"#10b981",actionProcessHover:"#059669",actionDeleteBg:"#ef4444",actionDeleteHover:"#dc2626",iconBgBlue:"#3b82f6",iconBgGreen:"#10b981",iconBgEmerald:"#10b981",iconBgPurple:"#8b5cf6",iconBgIndigo:"#6366f1",iconBgOrange:"#f97316",iconBgYellow:"#eab308",iconBgCyan:"#06b6d4",iconBgRed:"#ef4444",chartColor1:"#3b82f6",chartColor2:"#10b981",chartColor3:"#f59e0b",chartColor4:"#ef4444",chartColor5:"#8b5cf6",chartColor6:"#06b6d4",chartColor7:"#f97316",chartColor8:"#ec4899",chartBorderColor:"#e5e7eb",chartGridColor:"#d1d5db",chartTextColor:"#6b7280",chartCacheHitColor:"#047857",chartCacheMissColor:"#b45309",scrollbarTrack:"#e5e7eb",scrollbarThumb:"#9ca3af",scrollbarHover:"#6b7280",publicAccessBg:"#d1fae5",publicAccessText:"#047857",publicAccessBorder:"#86efac",securedAccessBg:"#fef3c7",securedAccessText:"#92400e",securedAccessBorder:"#fde047"}}]}async getTheme(e){const r=this.getBuiltInThemes().find(a=>a.meta.id===e);if(r)return r;try{const a=await fetch(`${u}/theme/${e}`);if(!a.ok)return null;const t=await a.text();return this.parseTomlTheme(t)}catch(a){return console.error("Error loading theme:",a),null}}parseTomlTheme(e){try{const r=Te.parse(e);return!r.meta||!r.meta.id||!r.meta.name?(console.error("Invalid theme: missing meta.id or meta.name"),null):r.colors?r:(console.error("Invalid theme: missing colors section"),null)}catch(r){return console.error("Error parsing TOML theme:",r),null}}async uploadTheme(e){const r=await e.text(),a=this.parseTomlTheme(r);if(!a)throw new Error("Invalid TOML theme format");const t=new FormData;t.append("file",e);try{const s=await fetch(`${u}/theme/upload`,{method:"POST",headers:G.getAuthHeaders(),body:t});if(!s.ok){const n=await s.json().catch(()=>({error:"Failed to upload theme"}));throw new Error(n.error||"Failed to upload theme")}return a}catch(s){throw s.message.includes("Failed to fetch")||s.message.includes("NetworkError")?new Error("Cannot save theme: API server is not running. Please start the LANCache Manager API service."):s}}async deleteTheme(e){const r=await fetch(`${u}/theme/${e}`,{method:"DELETE",headers:G.getAuthHeaders()});if(!r.ok&&r.status!==404){const a=await r.json().catch(()=>({error:"Failed to delete theme"}));throw new Error(a.error||"Failed to delete theme")}}applyDefaultVariables(){const e=`
    ...
    :root {
      ...
      --theme-text-placeholder: ${t.textPlaceholder||"#6b7280"};
      ...
      --theme-checkbox-accent: ${t.checkboxAccent||t.primaryColor||"#3b82f6"};
      --theme-checkbox-border: ${t.checkboxBorder||t.borderSecondary||"#4b5563"};
      --theme-slider-accent: ${t.sliderAccent||t.primaryColor||"#3b82f6"};
      --theme-slider-thumb: ${t.sliderThumb||t.primaryColor||"#3b82f6"};
      --theme-slider-track: ${t.sliderTrack||t.bgTertiary||"#374151"};
      ...
      --theme-public-access-bg: ${t.publicAccessBg||"rgba(16, 185, 129, 0.2)"};
      --theme-public-access-text: ${t.publicAccessText||"#34d399"};
      --theme-public-access-border: ${t.publicAccessBorder||"rgba(16, 185, 129, 0.3)"};
      --theme-secured-access-bg: ${t.securedAccessBg||"rgba(245, 158, 11, 0.2)"};
      --theme-secured-access-text: ${t.securedAccessText||"#fbbf24"};
      --theme-secured-access-border: ${t.securedAccessBorder||"rgba(245, 158, 11, 0.3)"};
    }
...
`),r+=`
`,r+=`[colors]
`,e.colors&&Object.entries(e.colors).forEach(([t,s])=>{r+=`${t} = "${s}"
`}),r+=`
...
//# sourceMappingURL=index-BbdyQxYZ.js.map
