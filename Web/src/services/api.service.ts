...
interface CachedGameDetectionResponse {
  ...
  // Omitted when the last scan was incremental, which has no cache index to measure against.
  unmapped_services?: UnmappedService[];
...
/** Result of POST persistent/logout after the daemon handles the requested running session. */
