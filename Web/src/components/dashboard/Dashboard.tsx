    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {visibleCards.map((card: StatCardData) => (
          <div
            key={card.key}
            className={`relative group ${dragOverCard === card.key ? 'ring-2 ring-blue-500' : ''}`}
            draggable
          ...
          >
            ...
            <button
              ...
              className="absolute top-2 right-2 p-1.5 rounded-lg bg-gray-700/50 opacity-0 group-hover:opacity-100 transition-opacity"
