...
interface CorruptionRemovalWarningProps {
   ...
   * "will delete" block and the two shared cautions (cannot be undone / may
   * take several minutes) are identical across every corruption removal modal;
 ...
 */
const CorruptionRemovalWarning: React.FC<CorruptionRemovalWarningProps> = ({ extraCautions }) => {
