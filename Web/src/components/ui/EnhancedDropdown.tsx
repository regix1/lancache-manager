...
export const EnhancedDropdown: React.FC<EnhancedDropdownProps> = ({
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <div
          ref={dropdownRef}
          className={`ed-dropdown fixed themed-border-radius border border-themed-primary overflow-hidden bg-themed-secondary max-w-[calc(100vw-32px)] shadow-[0_10px_25px_-5px_rgba(0,0,0,0.3),0_8px_10px_-6px_rgba(0,0,0,0.2)] z-[60] ${dropdownWidth?.trim().startsWith('w-') ? dropdownWidth : ''}`}
          style={{
                ...
                option.value === 'divider' ? (
                  ...
                  <React.Fragment key={option.value}>
                    ...
                    {expandedSubmenu === option.value && submenuPosition && createPortal(
                      <div
                        ref={submenuRef}
                        className="ed-dropdown fixed w-64 themed-border-radius border border-themed-primary overflow-hidden z-[65] bg-themed-secondary shadow-[0_10px_25px_-5px_rgba(0,0,0,0.3),0_8px_10px_-6px_rgba(0,0,0,0.2)] animate-[dropdownSlideDown_0.15s_cubic-bezier(0.16,1,0.3,1)]"
                        style={{
