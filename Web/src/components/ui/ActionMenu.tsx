  ...
  return (
    <div className="relative inline-flex">
      ...
      {isOpen && createPortal(
        <div
          ref={dropdownRef}
          className={`fixed ${width} bg-themed-secondary themed-border-radius shadow-xl overflow-hidden border border-themed-primary z-[60] animate-[dropdownSlide_0.15s_ease-out]`}
          style={{
            top: position.top,
            left: position.left,
          }}
