    ...
    >
      <defs>
        <linearGradient
          ...
          y2="17.357"
        >
          <stop offset="0" stopColor="var(--theme-button-text)" stopOpacity="0.2" />
          <stop offset="1" stopColor="var(--theme-button-text)" stopOpacity="0" />
        </linearGradient>
      </defs>
      <g>
        <path d="m12 11h11v-10l-11 1z" fill="currentColor" />
        <path d="m10 11v-8.8181763l-9 .8181763v8z" fill="currentColor" />
        <path d="m12 2v.25l11-1v-.25z" fill="var(--theme-button-text)" opacity={0.2} />
        <path d="m12 10.75h11v.25h-11z" opacity={0.1} />
        <path d="m1 3v.25l9-.8181763v-.25z" fill="var(--theme-button-text)" opacity={0.2} />
        ...
        <path d="m12 13h11v.25h-11z" fill="var(--theme-button-text)" opacity={0.2} />
        <path d="m1 21v-.25l9 .8181763v.25z" opacity={0.1} />
        <path d="m1 13h9v.25h-9z" fill="var(--theme-button-text)" opacity={0.2} />
        <path
