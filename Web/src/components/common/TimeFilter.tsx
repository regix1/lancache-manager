      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative">
          <button
            ...
            className={`ed-trigger w-full px-3 h-10 themed-border-radius-sm border text-left flex items-center justify-between text-sm cursor-pointer themed-card text-themed-primary ${isOpen ? 'border-[var(--theme-border-focus)]' : ''}`}
          >
            <div
              ...
              {iconOnly ? (
                ...
                <>
                  {selectedTimeOption?.icon && (
                    <selectedTimeOption.icon
                      className="flex-shrink-0 text-[var(--theme-primary)]"
                      size={16}
                    />
                  )}
            ...
            {selectedEventIds.length > 0 && (
              <span className="absolute -top-1 -right-1 themed-badge badge-count badge-count-on-color font-bold bg-[var(--theme-primary)] text-white shadow-sm">
          ...
          {present &&
            createPortal(
              ...
              >
                ...
                {/* Footer Note */}
                <div className="px-3 py-2.5 text-xs border-t flex items-start gap-2 text-[var(--theme-text-secondary)] border-[var(--theme-border-primary)] bg-[var(--theme-bg-tertiary)]">
