      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative">
          <button
            ...
            className={`ed-trigger w-full px-3 py-2 sm:px-3 sm:py-2 themed-border-radius border text-left flex items-center justify-between text-sm bg-[var(--theme-card-bg)] text-[var(--theme-text-primary)] ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'} ${isOpen ? 'border-[var(--theme-border-focus)]' : 'border-[var(--theme-border-primary)]'}`}
          >
            <div
