  ...
  if (isControlledByAdmin) {
    ...
    return (
      <Tooltip content={t('tooltips.refreshRateControlled')}>
        ...
        <div className="ed-trigger flex items-center justify-center gap-1.5 px-3 h-10 themed-border-radius-sm border border-themed-secondary text-sm cursor-not-allowed opacity-75">
