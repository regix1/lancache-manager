    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <h3 className="text-lg font-semibold text-themed-primary mb-1">
          {t('initialization.dataSource.title')}
        </h3>
      ...
      <div className="p-3 rounded-lg text-sm bg-themed-tertiary">
        <p className="text-themed-secondary">
          <strong className="text-themed-primary">
            {t('initialization.dataSource.whatIsDepotMapping')}
          </strong>{' '}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="p-4 rounded-lg border-2 flex flex-col bg-themed-tertiary border-themed-primary">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h4 className="font-semibold text-themed-primary">
              {t('initialization.dataSource.githubData')}
            </h4>
          </div>
          ...
          <Button variant="filled" color="blue" size="sm" onClick={onChooseGithub} fullWidth>
        ...
        <div className="p-4 rounded-lg border-2 flex flex-col bg-themed-tertiary border-themed-primary">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h4 className="font-semibold text-themed-primary">
              {t('initialization.dataSource.steamData')}
            </h4>
          </div>
          <p className="text-sm text-themed-secondary mb-3">
          ...
          <Button variant="filled" color="green" size="sm" onClick={onChooseSteam} fullWidth>
