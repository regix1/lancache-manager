...
public class XboxNamedDetectionEvictionTests
{
    ...
    /// <summary>
    /// Epic twin of the named-removal cleanup: active Epic removal must delete the Epic detection
    /// row (EpicAppId != null, keyed by GameName) without relying on the Epic mapping loop, and must
    /// leave same-name Steam/named rows intact (identity differs).
    /// </summary>
    [Fact]
