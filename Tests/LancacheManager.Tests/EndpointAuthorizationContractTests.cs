...
public sealed class EndpointAuthorizationContractTests
{
    ...
    private static readonly HashSet<string> AdminActions = new(StringComparer.Ordinal)
    {
        ...
        "ScheduleController.ClearNotificationDisplayMode",
        "ScheduleController.GetGlobalNotificationDisplayMode",
        "ScheduleController.SetGlobalNotificationDisplayMode",
    ...
    private static IEnumerable<string> ActionIdentities(string controller)
    {
        return controller switch
        {
            ...
            "OperationsController" => ["OperationsController.GetOperationStatus", "OperationsController.GetWaitingOperations", "OperationsController.GetRuns", "OperationsController.CancelOperation", "OperationsController.CloseRun", "OperationsController.ForceKill"],
            "PersistentPrefillController" => ["PersistentPrefillController.Start", "PersistentPrefillController.Stop", "PersistentPrefillController.CleanupEditSession", "PersistentPrefillController.List", "PersistentPrefillController.GetRuns", "PersistentPrefillController.GetRunFailedGames", "PersistentPrefillController.GetGames", "PersistentPrefillController.SetSelectedApps", "PersistentPrefillController.StartPrefill", "PersistentPrefillController.CancelPrefill", "PersistentPrefillController.GetIntegrationLoginAvailability", "PersistentPrefillController.StartLogin", "PersistentPrefillController.ProvideCredential", "PersistentPrefillController.GetChallenge", "PersistentPrefillController.CancelLogin", "PersistentPrefillController.Logout", "PersistentPrefillController.ClearLogins", "PersistentPrefillController.GetValidity", "PersistentPrefillController.SetValidity"],
