...
public sealed class GuestSessionDefaultsTests : IDisposable
{
    ...
    // and all six travel rather than only the clock ones. [5]
    [Fact]
    ...
    // preferences table is dropped so the write fails for real rather than through a stub. [7]
    [Fact]
    ...
    // saying UTC and local at once, or UTC on a 12-hour face, names none of them. [5]
    [Theory]
