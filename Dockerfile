...
# csproj embeds <EmbeddedResource Include="..\..\rust-processor\tact_products.json"> (and steam_fallback_appids.json);
...
COPY rust-processor/steam_fallback_appids.json /rust-processor/steam_fallback_appids.json
