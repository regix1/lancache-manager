...
- Use the "LANCache Manager" name or logo as the name or branding of your own
  fork, product, or service.
- Use the name or logo in a way that suggests your version is the official
  project, or that it is endorsed by or affiliated with this project.
- Use the name or logo in a way that is likely to cause confusion about the
